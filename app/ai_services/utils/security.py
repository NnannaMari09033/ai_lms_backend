...
# Removed: from profanity_check import predict as is_profane
...
class ContentValidator:
    ...
    def validate_educational_content(cls, content: str) -> Dict[str, any]:
        ...
        The profanity check logic has been removed.
        """
        issues = []
        # Adjusted starting score for validation since the 50-point profanity penalty is gone.
        # We can either start at 100 or adjust the threshold. Keeping score calculation logic simple.
        score = 100

        # Removed: Check for profanity
        # if is_profane(content):
        #     issues.append("Content contains inappropriate language")
        #     score -= 50 # This penalty is now removed.

        # Check content length
        # Starting penalty adjustment: 50 points was the profanity penalty.
        # To maintain the old 'pass' threshold of 70, we can increase the 'content too short' penalty.
        # Old 'Content too short' penalty was 30. New effective penalty is 30, but total possible deduction is now 50 points less.
        ...
        return {
            # Since the maximum possible deduction is now 60 (30+20+10) instead of 110 (50+30+20+10),
            # a score >= 70 threshold remains appropriate, as a clean result still gets 100 points.
            'is_valid': score >= 70,
            'score': max(0, score),
            'issues': issues,
